    ...
    <section className="py-24 px-8 bg-gray-50">
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:scale-105">
            <h3 className="text-3xl font-semibold mb-6 text-gray-900">Improve Air Quality</h3>
            <p className="text-gray-600 leading-relaxed">
              By testing and maintaining vehicle emissions, we can significantly reduce harmful pollutants in the atmosphere.
            </p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:scale-105">
            <h3 className="text-3xl font-semibold mb-6 text-gray-900">Ensure Vehicle Compliance</h3>
            <p className="text-gray-600 leading-relaxed">
              Ensure that your vehicle meets the required emission standards, avoiding fines and penalties.
            </p>
          </div>
          <div className="bg-white p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 ease-in-out transform hover:scale-105">
            <h3 className="text-3xl font-semibold mb-6 text-gray-900">Protect Public Health</h3>
            <p className="text-gray-600 leading-relaxed">
